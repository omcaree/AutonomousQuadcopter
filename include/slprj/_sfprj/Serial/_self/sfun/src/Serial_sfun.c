  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2280626958U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2833812603U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1237503747U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2971413067U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 5:
      {
        if (strcmp(aiChksum, "CrlpiPaIX5Hs0HNCaRx4PH") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 5:
      {
        if (strcmp(tpChksum, "Ju1tuWRpZoXzcgmvr7SxeE") == 0) {
