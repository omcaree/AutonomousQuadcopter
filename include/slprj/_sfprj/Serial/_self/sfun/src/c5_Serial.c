...
static const char * c5_g_debug_family_names[5] = { "length", "data2", "nargin",
  "nargout", "data" };
...
static boolean_T c5_dataWrittenToVector[8];
...
static void c5_enter_internal_Disarmed(SFc5_SerialInstanceStruct *chartInstance);
static void c5_exit_internal_Disarmed(SFc5_SerialInstanceStruct *chartInstance);
static void c5_exit_internal_Armed(SFc5_SerialInstanceStruct *chartInstance);
...
static void c5_requestStreams(SFc5_SerialInstanceStruct *chartInstance, uint8_T
  c5_data[256]);
static void c5_sendRPYT(SFc5_SerialInstanceStruct *chartInstance, uint8_T
  c5_data[256]);
static void c5_sendArmDisarmFun(SFc5_SerialInstanceStruct *chartInstance,
  uint8_T c5_data[256]);
static const mxArray *c5_e_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_g_emlrt_marshallIn(SFc5_SerialInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
...
static const mxArray *c5_f_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static const mxArray *c5_h_emlrt_marshallIn(SFc5_SerialInstanceStruct
...
static void initialize_c5_Serial(SFc5_SerialInstanceStruct *chartInstance)
{
  ...
  c5_temporalCounter_i1 = (uint8_T *)ssGetDWork(chartInstance->S, 6);
  ...
  *chartInstance)
{
  ...
  c5_d_hoistedGlobal = *c5_is_Disarmed;
  ...
  const mxArray *c5_st)
{
  ...
  *c5_is_Disarmed = c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c5_u, 4)), "is_Disarmed");
  *c5_is_Armed = c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c5_u, 5)), "is_Armed");
  *c5_temporalCounter_i1 = c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  if (*c5_is_active_c5_Serial == 0U) {
    ...
    *c5_is_c5_Serial = c5_IN_Initializing;
    ...
    for (c5_i5 = 0; c5_i5 < 256; c5_i5++) {
      _SFD_DATA_RANGE_CHECK((real_T)(*c5_dataOut)[c5_i5], 0U);
    }
    ...
    switch (*c5_is_c5_Serial) {
        ...
        switch (*c5_is_Armed) {
         case c5_IN_Flying:
          ...
          _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_c_nargout, 1U,
            c5_sf_marshallOut, c5_sf_marshallIn);
          c5_sendRPYT(chartInstance, c5_uv2);
          ...
          for (c5_i7 = 0; c5_i7 < 256; c5_i7++) {
            _SFD_DATA_RANGE_CHECK((real_T)(*c5_dataOut)[c5_i7], 0U);
          }
         ...
         case c5_IN_sendArm:
          ...
          c5_b_out = CV_EML_IF(6, 0, 0, *c5_temporalCounter_i1 >= 20);
          _SFD_SYMBOL_SCOPE_POP();
          if (c5_b_out) {
      ...
      if (c5_c_out) {
        ...
        *c5_temporalCounter_i1 = 0U;
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_g_nargout, 1U,
          c5_sf_marshallOut, c5_sf_marshallIn);
        c5_sendArmDisarmFun(chartInstance, c5_uv3);
        ...
        for (c5_i9 = 0; c5_i9 < 256; c5_i9++) {
          _SFD_DATA_RANGE_CHECK((real_T)(*c5_dataOut)[c5_i9], 0U);
        }
        ...
        switch (*c5_is_Disarmed) {
         ...
         case c5_IN_sendDisarm:
          ...
          _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_d_out, 2U,
            c5_d_sf_marshallOut, c5_d_sf_marshallIn);
          c5_d_out = CV_EML_IF(5, 0, 0, *c5_temporalCounter_i1 >= 20);
          _SFD_SYMBOL_SCOPE_POP();
          if (c5_d_out) {
     ...
     case c5_IN_Initializing:
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_j_nargin, 0U, c5_sf_marshallOut,
        c5_sf_marshallIn);
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_j_nargout, 1U, c5_sf_marshallOut,
        c5_sf_marshallIn);
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_e_out, 2U, c5_d_sf_marshallOut,
        c5_d_sf_marshallIn);
      c5_e_out = CV_EML_IF(1, 0, 0, *c5_dataReceived);
      _SFD_SYMBOL_SCOPE_POP();
      if (c5_e_out) {
        ...
        _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 2U, 2U, c5_c_debug_family_names,
          c5_debug_family_var_map);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_k_nargin, 0U, c5_sf_marshallOut,
          c5_sf_marshallIn);
  ...
  *c5_inData)
{
  ...
  for (c5_i12 = 0; c5_i12 < 256; c5_i12++) {
    c5_b_inData[c5_i12] = (*(uint8_T (*)[256])c5_inData)[c5_i12];
  }
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  for (c5_i15 = 0; c5_i15 < 256; c5_i15++) {
    (*(uint8_T (*)[256])c5_outData)[c5_i15] = c5_y[c5_i15];
  }
  ...
  c5_data[256])
{
  ...
  for (c5_i17 = 0; c5_i17 < 256; c5_i17++) {
    c5_data[c5_i17] = c5_data2[c5_i17];
  }
  ...
  uint8_T c5_data[256])
{
  ...
  int32_T *c5_sfEvent;
  c5_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 5U, 5U, c5_g_debug_family_names,
    c5_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_length, 0U, c5_c_sf_marshallOut,
    c5_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c5_data2, 1U, c5_b_sf_marshallOut,
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_y = c5_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_sfEvent), &c5_thisId);
  ...
  *c5_inData)
{
  ...
  for (c5_i23 = 0; c5_i23 < 4; c5_i23++) {
    c5_b_inData[c5_i23] = (*(real_T (*)[4])c5_inData)[c5_i23];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3648166261U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2964810670U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1952206375U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2361987297U);
}
...
mxArray *sf_c5_Serial_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("CrlpiPaIX5Hs0HNCaRx4PH");
...
static const mxArray *sf_get_sim_state_info_c5_Serial(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[17],T\"dataOut\",},{M[1],M[18],T\"lengthOut\",},{M[8],M[0],T\"is_active_c5_Serial\",},{M[9],M[0],T\"is_c5_Serial\",},{M[9],M[2],T\"is_Disarmed\",},{M[9],M[3],T\"is_Armed\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M1x2[20 31],M[1]}}}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(8,0,"sendArmDisarmFun",0,-1,233);
        _SFD_CV_INIT_EML_IF(8,1,0,114,138,-1,230);
...
{
  const char *infoEncStr[] = {
    "100 S1x4'varName','path'{{T\"is_active_c5_Serial\",T\"is_active_c5_Serial\"},{T\"is_c5_Serial\",T\"is_c5_Serial\"},{T\"is_Disarmed\",T\"Disarmed.is_Disarmed\"},{T\"is_Armed\",T\"Armed.is_Armed\"}}"
  };
...
static void sf_set_sfun_dwork_info(SimStruct *S)
{
  const char *dworkEncStr[] = {
    "100 S1x7'type','isSigned','wordLength','bias','slope','exponent','isScaledDouble','isComplex','size'{{T\"int32\",,,,,,,M[0],M[]},{T\"boolean\",,,,,,,M[0],M[]},{T\"uint8\",,,,,,,M[0],M[]},{T\"uint8\",,,,,,,M[0],M[]},{T\"uint8\",,,,,,,M[0],M[]},{T\"uint8\",,,,,,,M[0],M[]},{T\"uint8\",,,,,,,M[0],M[]}}"
  };
...
static uint32_T* sf_get_sfun_dwork_checksum()
{
  static uint32_T checksum[4] = { 3992968016U, 11634701U, 4216139156U,
    202464229U };
...
static void mdlSetWorkWidths_c5_Serial(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3348521130U));
  ssSetChecksum1(S,(1351952266U));
  ssSetChecksum2(S,(3337096061U));
  ssSetChecksum3(S,(1307423077U));
