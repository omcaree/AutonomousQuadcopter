...
static const char * c14_debug_family_names[4] = { "status", "nargin", "nargout",
  "armed" };
...
static const mxArray *c14_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static uint8_T c14_emlrt_marshallIn(SFc14_RaspPiPilotInstanceStruct
  *chartInstance, const mxArray *c14_armed, const char_T *c14_identifier);
static uint8_T c14_b_emlrt_marshallIn(SFc14_RaspPiPilotInstanceStruct
...
static const mxArray *c14_b_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static real_T c14_c_emlrt_marshallIn(SFc14_RaspPiPilotInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
...
static const mxArray *c14_c_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static int32_T c14_d_emlrt_marshallIn(SFc14_RaspPiPilotInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
  ...
  (SFc14_RaspPiPilotInstanceStruct *chartInstance)
{
  ...
  uint8_T *c14_armed;
  c14_armed = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c14_st = NULL;
  c14_st = NULL;
  c14_y = NULL;
  sf_mex_assign(&c14_y, sf_mex_createcellmatrix(2, 1), false);
  c14_hoistedGlobal = *c14_armed;
  c14_u = c14_hoistedGlobal;
  c14_b_y = NULL;
  sf_mex_assign(&c14_b_y, sf_mex_create("y", &c14_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c14_y, 0, c14_b_y);
  c14_b_hoistedGlobal = chartInstance->c14_is_active_c14_RaspPiPilot;
  ...
  *chartInstance, const mxArray *c14_st)
{
  ...
  *c14_armed = c14_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c14_u, 0)), "armed");
  chartInstance->c14_is_active_c14_RaspPiPilot = c14_emlrt_marshallIn
  ...
  *chartInstance)
{
  ...
  uint8_T c14_armed;
  uint8_T *c14_b_armed;
  c14_b_armed = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c14_status, 0U, c14_sf_marshallOut,
    c14_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c14_nargout, 2U, c14_b_sf_marshallOut,
    c14_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c14_armed, 3U, c14_sf_marshallOut,
    c14_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  *c14_b_armed = c14_armed;
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*c14_b_armed, 0U);
}
  ...
  *chartInstance, const mxArray *c14_armed, const char_T *c14_identifier)
{
  ...
  c14_y = c14_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c14_armed),
    &c14_thisId);
  sf_mex_destroy(&c14_armed);
  return c14_y;
}
...
static void c14_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData)
{
  const mxArray *c14_armed;
  const char_T *c14_identifier;
  emlrtMsgIdentifier c14_thisId;
  uint8_T c14_y;
  SFc14_RaspPiPilotInstanceStruct *chartInstance;
  chartInstance = (SFc14_RaspPiPilotInstanceStruct *)chartInstanceVoid;
  c14_armed = sf_mex_dup(c14_mxArrayInData);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(11646771U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3570317395U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2058603677U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1440849797U);
}
...
mxArray *sf_c14_RaspPiPilot_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("l9G7QTYZtAVNpVNKYj3GhB");
...
static const mxArray *sf_get_sim_state_info_c14_RaspPiPilot(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[8],T\"armed\",},{M[8],M[0],T\"is_active_c14_RaspPiPilot\",}}"
  };
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,2,0,1,"armed");
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,64,88,-1,162);

        {
          static int condStart[] = { 68 };

          static int condEnd[] = { 88 };

          static int pfixExpr[] = { 0, -1 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,67,88,1,0,&(condStart[0]),&(condEnd[0]),2,
                                &(pfixExpr[0]));
        }
...

        {
          uint8_T *c14_armed;
          c14_armed = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          _SFD_SET_DATA_VALUE_PTR(0U, c14_armed);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c14_RaspPiPilot(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(795691360U));
  ssSetChecksum1(S,(2838736756U));
  ssSetChecksum2(S,(407381487U));
  ssSetChecksum3(S,(960370474U));
