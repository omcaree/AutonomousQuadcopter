...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3004388312U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(377635048U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2173133956U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4237954232U);
}
...
mxArray *sf_c1_RaspPiPilot_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("xbfk3Pfr3ildRCimtA4BgD");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,98,107,-1,128);
        _SFD_CV_INIT_EML_IF(0,1,1,129,153,-1,592);
        _SFD_CV_INIT_EML_IF(0,1,2,266,276,485,566);
        _SFD_CV_INIT_EML_IF(0,1,3,351,363,399,444);
        _SFD_CV_INIT_EML_FOR(0,1,0,158,174,583);

        {
          static int condStart[] = { 133 };

          static int condEnd[] = { 153 };

          static int pfixExpr[] = { 0, -1 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,132,153,1,0,&(condStart[0]),&(condEnd[0]),
                                2,&(pfixExpr[0]));
        }
...
static void mdlSetWorkWidths_c1_RaspPiPilot(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1739353233U));
  ssSetChecksum1(S,(1802432356U));
  ssSetChecksum2(S,(3493821152U));
  ssSetChecksum3(S,(719445766U));
